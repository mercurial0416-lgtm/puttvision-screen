...
p=Path('app/src/test/java/com/puttvision/screen/V28CompanionProtocolTest.kt')
if not p.exists():
    p.write_text('''package com.puttvision.screen
...
''', encoding='utf-8')
    print('V28 companion protocol test created')
else:
    print('V28 companion protocol test current')
