...
# Focus coaching is prospective. Samples captured before a new LINE/PACE/BOTH objective became
# active must not be retroactively re-scored under the new objective, or a focus switch can fabricate
# a streak/failure state the player never actually earned against that cue.
